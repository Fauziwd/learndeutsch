...
const Sidebar = () => {
  ...
  className="fixed top-0 left-0 z-50 h-screen p-4 overflow-y-auto transition-transform -translate-x-full w-80 bg-gray-300 dark:bg-gray-800 backdrop-blur-lg"
...
>
        ...
        <h5
          ...
          class="text-base font-semibold  uppercase dark:text-white text-gray-800 hover:text-white"
        >
          Menu
        </h5>
        <button
          ...
          class="text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
        >
          <svg
            aria-hidden="true"
            class="w-5 h-5"
        ...
        <div class="py-4 overflow-y-auto">
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2  transition duration-75 rounded-lg group hover:bg-gray-800 dark:text-white text-gray-800 hover:text-white dark:hover:bg-gray-700"
              ...
              <ul id="dropdown-example" className="hidden py-2 space-y-2">
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-800 dark:text-white text-gray-800 hover:text-white dark:hover:bg-gray-700"
                ...
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-900 hover:text-white dark:text-white text-gray-800 hover:text-white dark:hover:bg-gray-700"
                ...
                <hr />
                <h2 className="dark:text-white text-gray-800 hover:text-white">Tema Lain</h2>
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-blue-300 dark:text-white text-gray-800 hover:text-white dark:hover:bg-blue-500"
                ...
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-green-900 hover:text-white dark:text-white text-gray-800 hover:text-white dark:hover:bg-green-500"
...
<p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
  Rencana disini akan kita kasih jadwal waktu sholat ygy..  🙏🏻 😊
</p>
<a class="text-sm text-blue-200 font-medium hover:text-blue-900 dark:text-blue-200 dark:hover:text-blue-300" href="/404.html">Selengkapnya..</a>
</div>
      </div>
    </>
  );
