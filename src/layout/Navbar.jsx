...
<nav class="z-40 w-full bg-white border-gray-200 dark:bg-gray-900 shadow-xl" style={{ fontFamily: 'Montserrat, sans-serif' }}>
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <a href="/" class="flex items-center">
      {/* <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" /> */}
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">IDBC International</span>
  </a>
