  ...
  return (
    <>
      ...
      <div className="mx-auto p-8 h-screen bg-white dark:bg-gray-900 shadow-md" style={{ fontFamily: "Montserrat" }}>
        <h1 className="text-2xl dark:text-white font-bold mb-4">Data Kata Benda</h1>
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                {data
                  ...
                  .map((item, index) => (
                    <tr key={index}>
                      <td className="p-3 border border-gray-300">{item.sifat}</td>
                      <td className="p-3 border border-gray-300">{item.artiSifat}</td>
                    </tr>
                  ))}
              </tbody>
            </table>
